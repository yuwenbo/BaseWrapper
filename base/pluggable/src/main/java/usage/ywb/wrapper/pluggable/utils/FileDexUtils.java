...
public class FileDexUtils {
    ...
    public static void loadFixedDex(Context context, File patchFilesDir) {
        ...
        // 遍历所有的修复dex
        File fileDir = patchFilesDir != null ? patchFilesDir : context.getCacheDir();// data/data/包名/files/odex（这个可以任意位置）
    ...
    private static void doDexInject(Context appContext, HashSet<File> loadedDex) {
        ...
        try {
            ...
            for (File dex : loadedDex) {
                ...
                FieldUtil.setField(pathList.getClass(), pathList, "dexElements", dexElements);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static Object getPathList(Object baseDexClassLoader) throws Exception {
        return FieldUtil.getField(Class.forName("dalvik.system.BaseDexClassLoader"), baseDexClassLoader, "pathList");
    }
    ...
    private static Object getDexElements(Object pathList) throws Exception {
        return FieldUtil.getField(pathList.getClass(), pathList, "dexElements");
    }
