...
public class WheelRecycle {
    ...
    /**
     * Recycles items from specified main_layout.
     * There are saved only items not included to specified range.
     * All the cached items are removed from original main_layout.
     *
     * @param layout the main_layout containing items to be cached
     * @param firstItem the number of first item in main_layout
