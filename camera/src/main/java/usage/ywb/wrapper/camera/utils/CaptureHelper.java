package usage.ywb.wrapper.camera.utils;
...
import usage.ywb.wrapper.camera.camera1.Camera1Launcher;
import usage.ywb.wrapper.camera.camera2.Camera2Launcher;
import usage.ywb.wrapper.camera.interfaces.CameraLauncher;
import usage.ywb.wrapper.camera.interfaces.OnCaptureListener;
