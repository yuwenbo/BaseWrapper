package usage.ywb.wrapper.container.recycleview.wrapper;
...
import usage.ywb.wrapper.container.recycleview.utils.WrapperUtils;
...
public class HeaderAndFooterWrapper<T extends RecyclerView.Adapter> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HeaderAndFooterWrapper(T adapter) {
