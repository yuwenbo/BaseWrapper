...
public class ColorPickerDialog extends Dialog implements ColorPickerView.OnColorChangedListener,
    ...
    private void setUp(int color) {
        ...
        mColorPicker = (ColorPickerView) layout.findViewById(R.id.cpv_color_picker_view);
        mOldColor = (ColorPickerPanelView) layout.findViewById(R.id.cppv_old_color_panel);
        mNewColor = (ColorPickerPanelView) layout.findViewById(R.id.cppv_new_color_panel);

        mHexVal = (EditText) layout.findViewById(R.id.et_hex_val);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.cppv_new_color_panel) {
            if (mListener != null) {
