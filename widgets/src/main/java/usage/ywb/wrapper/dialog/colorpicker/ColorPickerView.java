package usage.ywb.wrapper.dialog.colorpicker;/*
...
public class ColorPickerView extends View {
    ...
    private void drawSatValPanel(Canvas canvas) {
        ...
        //HSV转化为RGB
        int rgb = Color.HSVToColor(new float[]{mHuesss, 1f, 1f});
        //饱和线性渲染器
    ...
    private void drawAlphaPanel(Canvas canvas) {
        ...
        float[] hsv = new float[]{mHuesss, mSat, mVal};//hsv数组
    ...
    public boolean onTrackballEvent(MotionEvent event) {
        ...
        if (update) {
            if (mListener != null) {
                mListener.onColorChanged(Color.HSVToColor(mAlpha, new float[]{mHuesss, mSat, mVal}));
            }
            invalidate();
            return true;
        }
     ...
     */
    public int getColor() {
        return Color.HSVToColor(mAlpha, new float[]{mHuesss, mSat, mVal});
    }
